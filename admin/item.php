...
<?php require(__DIR__ . '/tmp/header.php'); ?>
    ...
    <div id="contents" class="container">
      ...
      <div class="row heading-post">
        <h2 class="col-sm-10">投稿詳細<?= '('.h($cat_name_ja).')'; ?></h2>
        <div class="col-sm-2">
      ...
      <form action="insert.php" method="post">
        ...
        <div>
          ...
          <p>画像ファイル名<input type="text" name="product_imgpath" value="<?= $product['product_imgpath'] ?>"></p>
        </div>
        <p>商品名:<br>
          <input type="text" name="product_ttl" value="<?= $product['product_ttl'] ?>">
        </p>
        <p>商品説明:<br>
          <textarea name="product_exp"><?= $product['product_exp'] ?></textarea>
        </p>
        <p>価格:<br>
